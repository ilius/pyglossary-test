...
{the }sample headword
   ...
   \ 
   •• [b]Links:[/b]
   \<<typical card\>> • <<typical card>> • Recommended way to create a hyperlink to another card.
   \[ref\]typical card\[/ref\] • [ref]typical card[/ref] • hyperlink to another card, not recommended, deprecated.
   \[ref target="typical card"\]linked text\[/ref\] • [ref target="typical card"]linked text[/ref] • hyperlink to another card, when card address is different from linked text
   \[ref dict="Persian Idioms (Fa-Fa)"\]break the leg\[/ref\] • [ref dict="Persian Idioms (Fa-Fa)"]break the leg[/ref] • hyperlink to a card in another dictionary by dict ID
   \[url\]http://goldendict.org/\[/url\] • [url]http://goldendict.org/[/url] • link to a Web page
   \[url target="http://goldendict.org/"\]Goldendict website\[/url\] • [url target="http://goldendict.org/"]Goldendict website[/url] • any text hyperlinked to a Web page
   \ 
   •• [b]Colors:[/b]
